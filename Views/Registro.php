...
<body>
    ...
    <div class="signupFrm">
        ...
        <form role="form" class="text-start" action="" method="post">
            ...
            <div class="form-outline mb-4">
                <input id="txtApellido" name="txtApellido" type="text" class="form-control form-control-lg"
            ...
            <div class="form-outline mb-4">
                <input id="txtTelefono" name="txtTelefono" type="text" class="form-control form-control-lg"
            ...
            <div class="pt-1 mb-4">
                <button id="btnRegistro" name="btnRegistro" type="submit"
                    class="btn btn-dark btn-lg btn-block">Registrarse</button>
            </div>

            <p class="mt-4 text-sm text-center">
                ¿Ya tienes una cuenta?
                <a href="index.php" class="text-primary text-gradient font-weight-bold">Ir al Inicio de Sesión</a>
            </p>
        </form>
    </div>
